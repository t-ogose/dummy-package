...
const getFileFromId = (id) => normalizePath(id).split("?")[0];
...
export { getFilter as a, getWatcher as b, getFileFromId as c, getLintFiles as d, getOptions as g, initialStylelint as i, pluginName as p, shouldIgnore as s };
